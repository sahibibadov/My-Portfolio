...
const Hero = () => {
  return (
    <MotionElement className="~mt-10/32 text-center w-full">
      <SparklesPreview className="text-5xl md:text-6xl lg:text-7xl">
        Hi, I&apos;m Ibadov Sahib
      </SparklesPreview>

      <div className="~text-xl/4xl text-neutral-500 dark:text-neutral-400 font-semibold ~mb-2/6">
        <span className="mr-1">Frontend Developer</span>
        <Typeanimationtext />
      </div>

      <p className="text-neutral-500 dark:text-neutral-400 max-w-xl mx-auto ~text-base/xl ~mb-2/6">
