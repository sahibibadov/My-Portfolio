...
const Contact = () => {
  return (
    <section className="~mt-10/16  w-full  ">
      ...
      <div className="flex flex-col md:flex-row gap-4 ~mt-3/10">
        {/* eratch */}
        <div className="relative aspect-square flex-1 w-[350px]  h-[350px] mx-auto md:mx-0   md:w-full md:h-full  md:max-w-[500px] md:max-h-[500px] md:-translate-y-7 md:-translate-x-7">
          <Earth />
        </div>
        {/* form */}
